...
/**
 * @callback AsyncHighlighterCallback
 ...
 * @property {ElementCallback} [callback] An optional callback to be invoked after the highlighting is done.
...
/**
 * @typedef {AsyncHighlighterCallback} AsyncHighlighter
 */
