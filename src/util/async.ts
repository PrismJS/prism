export function documentReady (document = globalThis.document) {
	...
	// DOMContentLoaded event because there might be some plugins or languages that have also been deferred, and they
	// might take longer than one animation frame to execute, which can create a race condition where only some plugins have
...
// Inspired https://github.com/mavoweb/mavo/blob/78efe2b9cadd09c1d131b8afd5fe2f38d5cfa8c7/src/mavo.js#L845
