...
Prism.languages.stan = {
	'comment': /\/\/.*|\/\*[\s\S]*?\*\/|#(?!include).*/,
	'string': {
		// String literals can contain spaces and any printable ASCII character except " and \
	...
	'keyword': [
		...
		// these are function that are known to take another function as their first argument.
